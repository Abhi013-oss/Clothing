    ...
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-24">
      <ScrollReveal direction="up" delay={50}>
        <div className="flex flex-col sm:flex-row items-center sm:items-start text-center sm:text-left gap-4 mb-6">
          <div className="relative w-16 h-16 sm:w-20 sm:h-20 flex-shrink-0 rounded-full overflow-hidden border border-ink-border/80 shadow-md bg-white mx-auto sm:mx-0">
            <Image
              src="/images/logo.png"
        ...
        <div className="prose prose-stone font-sans text-ink-secondary leading-relaxed space-y-4 text-center sm:text-left">
          <p>
