      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 pt-12">
          {googleReviewsData.reviews.map((rev) => (
            <div
              key={rev.id}
              className="bg-canvas-pure p-6 sm:p-7 rounded-sm border border-ink-border shadow-card-rest hover:shadow-card-hover transition-all duration-300 flex flex-col justify-between"
            >
              <div>
                {/* Reviewer Header */}
          ...
          <div className="bg-canvas-pure p-6 sm:p-7 rounded-sm border-2 border-dashed border-accent-gold/60 flex flex-col justify-between items-center text-center">
