      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          ...
          <ScrollReveal direction="right" delay={100} className="lg:col-span-5 relative order-2 lg:order-1">
            ...
            <div className="absolute bottom-3 left-1/2 -translate-x-1/2 sm:left-auto sm:translate-x-0 sm:-bottom-6 sm:-right-6 bg-canvas-pure p-3.5 sm:p-5 rounded-sm border border-ink-border shadow-card-hover w-max max-w-[240px] sm:max-w-[250px] flex items-center gap-3 sm:gap-3.5 animate-scale-up">
          ...
          {/* Narrative Column */}
          <ScrollReveal direction="left" delay={50} className="lg:col-span-7 flex flex-col items-center lg:items-start text-center lg:text-left order-1 lg:order-2">
            <span className="font-sans text-xs uppercase tracking-widest text-accent-gold font-semibold mb-2 mx-auto lg:mx-0">
              Our Heritage & Values
            </span>
            ...
            <p className="font-sans text-base text-ink-secondary leading-relaxed mb-6 max-w-xl mx-auto lg:mx-0">
            ...
            <p className="font-sans text-sm sm:text-base text-ink-secondary leading-relaxed mb-8 max-w-xl mx-auto lg:mx-0">
            ...
            <Link
              href="/about"
              className="inline-flex items-center gap-2 font-sans text-sm font-semibold text-ink hover:text-accent-gold transition-colors group mx-auto lg:mx-0"
            >
